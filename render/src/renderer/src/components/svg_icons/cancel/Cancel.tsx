...
function Cancel({
  ...
  return (
    ...
    >
      <defs>
        <filter id="cancelGlow" width="200%" height="200%" dx="0" dy="0">
          <feMorphology in="SourceGraphic" operator="dilate" radius={1} result="tickened" />
          <feGaussianBlur in="tickened" stdDeviation={1.5} result="blurred" />
          <feFlood floodColor="#334155" floodOpacity="1" result="glowColor" />
